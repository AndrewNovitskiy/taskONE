...
public interface ScheduledTransaction extends org.apache.logging.log4j.samples.dto.AuditEvent {
    ...
    /**
     * Action : Indicates the step of the registration process.  Valid action are: Begin, Submit, Enroll Cancel,
     ...
     *
     * @param action Indicates the step of the registration process.  Valid action are: Begin, Submit, Enroll Cancel,
