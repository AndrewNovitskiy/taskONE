...
/**
 * A <code>RollingPolicy</code> specifies the action taken on a logging file rollover.
 *
 */
public interface RolloverStrategy {
     ...
     * preliminary action and describes action needed after close of current log file.
     *
