...
public class DefaultRolloverStrategy implements RolloverStrategy {
     ...
     * @param customActions custom action to perform asynchronously after rollover
     * @param stopCustomActionsOnError whether to stop executing asynchronous action if an error occurs
