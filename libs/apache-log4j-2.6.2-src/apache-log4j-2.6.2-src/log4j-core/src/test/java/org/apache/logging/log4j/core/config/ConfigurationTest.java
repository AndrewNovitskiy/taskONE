...
/**
 * Unit test for testing various supported configuration file formats. Each configuration file format should provide a
 * compatible configuration to get some sweet, sweet test.
 */
